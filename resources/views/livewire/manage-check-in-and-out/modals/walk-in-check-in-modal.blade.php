        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document" >
            <div class="modal-content" @if($hide == true) style="opacity: 0%" @endif>
                <div class="modal-header" style="background-color: #191c24">
                    <h5 class="modal-title mr-2">Guest Check In Form</h5> (<span class="text-danger text-small">*</span>) required
                        ...
                        <div class="cotainer ml-4">
                            <form wire:submit.prevent="submit">
                                ...
                                <div class="form-group w-100 mb-3">
                                    ...
                                    <input wire:model.live.debounce.500ms="contact_no" class="form-control" id="contact_no" type="number" placeholder="Enter Phone Number"/>
                                    @error('contact_no')
                                    <span class="text-danger text-xs">{{$message}}</span> 
                                    @enderror
                                </div>
                                <div class="form-group w-100 mb-3">
                                    ...
                                    <input wire:model.live.debounce.500ms="email" class="form-control" id="email" type="email" placeholder="Enter Email Adrress"/>
                                    @error('email')
                                    <span class="text-danger text-xs">{{$message}}</span> 
                                    @enderror
                                </div>
                                ...
                                <div class="d-flex justify-content-between mb-3 form-group">
                                    <div class="form-group mr-3 w-100">
                                            ...
                                            @error('extra_bed')
                                            <span class="text-danger text-xs error">{{$message}}</span> 
                                        @enderror
                                    </div>
                                    <div class="form-group w-100">
                            ...
                            {{-- @if($children_no > 0 && $room_no == '')
                                ...
                                {{ $errors->any() || is_null($firstname) || is_null($lastname) || is_null($contact_no) || is_null($advance_payment) || is_null($check_in) || is_null($check_out) || is_null($roomtype_id) || is_null($room_id) || in_array('', $child_ages) ? 'disabled' : '' }}>Proceed Check In</button>
                            @elseif($children_no == 0 && $room_no > 0)
                                <button type="submit" class="btn btn-primary btn-lg rounded-pill w-100 mt-4"
                                {{ $errors->any() || is_null($firstname) || is_null($lastname) || is_null($contact_no) || is_null($advance_payment) || is_null($check_in) || is_null($check_out) || is_null($roomtype_id) || in_array('', $room_id) ? 'disabled' : '' }}>Proceed Check In</button>
                            @elseif($children_no > 0 && $room_no > 0)
                                <button type="submit" class="btn btn-primary btn-lg rounded-pill w-100 mt-4"
                                {{ $errors->any() || is_null($firstname) || is_null($lastname) || is_null($contact_no) || is_null($advance_payment) || is_null($check_in) || is_null($check_out) || is_null($roomtype_id) || in_array('', $room_id)|| in_array('', $child_ages) ? 'disabled' : '' }}>Proceed Check In</button>
                            @else
                                <button type="submit" class="btn btn-primary btn-lg rounded-pill w-100 mt-4"
                                {{ $errors->any() || is_null($firstname) || is_null($lastname) || is_null($contact_no) || is_null($advance_payment) || is_null($check_in) || is_null($check_out) || is_null($roomtype_id) || is_null($room_no) ? 'disabled' : '' }}>Proceed Check In</button>
                            @endif --}}
