...
class EditGuestRecordModal extends Component
{
    public function render()
    {
        return view('livewire.manage-booking.modals.edit-guest-record-modal');
    }
    ...
    public function bookingModal($id){
        ...
        $this->dispatch('show-edit-booking-modal');
    }
...
public function submit()
    {
        ...
        $this->dispatch('update-booking-success');
